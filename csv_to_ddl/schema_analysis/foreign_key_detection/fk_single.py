...
from csv_to_ddl.schema_analysis.foreign_key_detection.fk_map import get_single_column_values_from_data
            ...
            for ref_col, ref_values in ref_data['single_keys'].items():
                ...
                if match_score and match_score > best_score:
                    ...
                    best_match = ForeignKeySpec(columns=[col.name],
                                                ...
                                                reasoning=f"{overlap_ratio:.1%} value overlap with strong relationship indicators")
