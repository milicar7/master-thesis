...
def test_normalization():
    csv_file = os.path.join(os.path.dirname(__file__), "test_data_complex_normalization.csv")
    ...
    result = subprocess.run([sys.executable, main_py,
                             '-i', csv_file,
                             '-o', 'testing/normalization/schema.sql',
                             '-r', 'testing/normalization/report.json',
